### L05T3: Funktio parametreilla, toistorakenteet 
##
##def toisto():
##    sana = teksti
##    arvo = luku
...
### 1. versio - silmukat
##for sarake in range(1,5):
##    for rivi in range(1,5):
##        print(sarake * rivi, end='\t')
##    print()
##        
##
##
### 2. versio - aliohjelma
##def kertolaskutaulukko4():
##    for sarake in range(1,5):
##        for rivi in range(1,5):
##            print(sarake * rivi, end='\t')
##        print()
...
##kertolaskutaulukko4()
##
### 3. versio -aliohjelma, parametrilla
##def kertolaskutaulukko(lkm):
##    for sarake in range(1,lkm+1):
##        for rivi in range(1,lkm+1):
##            print(sarake * rivi, end='\t')
##        print()
##    return None
##
####kertolaskutaulukko(4)
####print()
####kertolaskutaulukko(6)
####print()
##
##### 4. versio -aliohjelma, parametrilla
####numero=int(input("Minkä luvun kertolaskun haluat tulostaa?: "))
####kertolaskutaulukko(numero)
####print()
##
### 5. versio -aliohjelma, parametrilla ja toistolla
##while(True):
##    numero=int(input("Minkä luvun kertolaskun haluat tulostaa?: "))
##    if(numero==0):
##        break
